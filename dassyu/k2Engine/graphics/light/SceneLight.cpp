...
namespace nsK2Engine {
    ...
    {
        // 太陽光
        m_light.directionalLight[0].color.x = 6.5f;
        m_light.directionalLight[0].color.y = 6.5f;
        m_light.directionalLight[0].color.z = 6.5f;

        m_light.directionalLight[0].direction.x = 0.0f;
        m_light.directionalLight[0].direction.y = 0.1f;
